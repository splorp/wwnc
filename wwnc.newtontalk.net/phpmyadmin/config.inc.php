 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://wwnc.newtontalk.net/phpmyadmin/';
...
$cfg['Servers'][$i]['user']          = 'wwnc';      // MySQL user
$cfg['Servers'][$i]['password']      = '';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'wwnc_newtontalk_net';          // If set to a db-name, only
