...
<html>
	...
	<body>
		<div id="container">
			<div id="header">
				<img src="/image/wwnc-header2006.jpg" alt="Worldwide Newton Conference - San Francisco, California - January 2006" width="630" height="180" border="0" />
			</div>
			...
			<div id="content">
				...
				<div class="chunk">
				<h1>WWNC Presentations Now Available</h1>
				<p>The majority of the presentations from the 2006 Worldwide Newton Conference <a href="/program/" title="View the scheduled presentations and casual workshops.">program</a> are now available in PDF format from the <a href="/resources/" title="Press coverage, blog buzz, downloads, and more.">resources</a> page. Additional information from the conference, as well as the remaining presentations will be posted shortly. Thank you for your patience.</p>
				</div>
				...
				<p>The conference will take place at the <a href="/venue/" title="View information about the conference venue.">The Warwick Regis Hotel</a> in downtown San Francisco. A discounted room rate is available for conference attendees.</p>
